...
struct Constants {
    struct ImageConstants {
        ...
        static let tabLiveTV = "play.tv"
        static let tabMovies = "film"
        static let tabSeries = "play.rectangle"
        ...
        static let tabRecent = "clock.arrow.circlepath"
